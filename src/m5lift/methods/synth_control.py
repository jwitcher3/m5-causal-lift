...
def main():
    ...
    # Truth on the same scale SCM is estimating: average daily total tau during campaign
    att_true = float(
    ...
    # Pivot donors wide (rows=date, cols=donor_id)
    donor_wide = (
    ...
    # Predict counterfactual on fit scale, then back-transform if needed
